...
- [x] **Task 1.1: Project & Theme Setup**
...
- [x] **Task 1.2: Local Database (Room)**
  - Implement `ReportEntity`, `MediaItemEntity`, Room DAOs, and Type Converters.
- [x] **Task 1.3: Navigation & Capture UI (Screens 01 & 02)**
...
- [x] **Task 1.4: Voice Capture Screen (Screen 03)**
...
- [x] **Task 1.5: Native PDF Engine & ShareSheet (Screen 05)**
...
- [x] **Task 2.3: WorkManager Resilient Sync**
...
- [x] **Task 3.1: Cloud Run Fastify Service Scaffold**
...
- [x] **Task 3.2: Speech-to-Text & Gemini Flash Integration**
...
- [x] **Task 3.3: AI Review & Approval Gate (Screen 04)**
...
- [x] **Task 4.1: Offline & Network Dropout Resilience Testing**
...
- [x] **Task 4.2: Hardware & Ergonomic Polish**
...
- [x] **Task 4.3: Closed Pilot Distribution**
